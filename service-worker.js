const CACHE = 'samara-erp-2.9.58-mail-signature-footer';
const SHELL = [
  './', './index.html', './styles.css?v=2.9.58', './app.js?v=2.9.58',
  './bootstrap-error.js?v=2.8.40', './health-check.js?v=2.8.40',
  './config.js?v=2.9.58', './manifest.webmanifest?v=2.8.40', './assets/samara-mail-logo.png',
