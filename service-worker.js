const CACHE = 'samara-erp-2.9.50-updateprompt-permanent-fix';
const SHELL = [
  './', './index.html', './styles.css?v=2.9.50', './app.js?v=2.9.50',
  './bootstrap-error.js?v=2.8.40', './health-check.js?v=2.8.40',
  './config.js?v=2.9.50', './manifest.webmanifest?v=2.8.40',
