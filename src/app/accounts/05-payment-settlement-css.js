  const ensurePaymentSettlementStyle = () => {
    ...
    style.textContent=`
      ...
      .samara-payment-request-card{max-width:920px;margin:0 auto;border:1px solid #edc5d7;border-radius:18px;background:#fff;padding:20px}.samara-payment-request-summary{display:grid;grid-template-columns:1.4fr 1fr .8fr;gap:12px}.samara-payment-request-summary>div{padding:13px 15px;border-radius:13px;background:#fff5f9}.samara-payment-request-summary span,.samara-payment-link-box span{display:block;font-size:12px;color:#7b6872;margin-bottom:5px}.samara-payment-request-summary strong{color:#432331;font-size:16px}.samara-payment-request-amount{font-size:24px!important;color:#a10c52!important}.samara-payment-link-box{margin:14px 0;padding:12px 15px;border:1px dashed #e2a7c1;border-radius:12px;background:#fffafd}.samara-payment-link-box code{font-family:inherit;color:#6d2146;word-break:break-all}.samara-payment-action-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.samara-payment-request-foot{margin-top:12px;font-size:12px;color:#76636d}.samara-payment-send-status{display:flex;align-items:center;gap:13px;margin:14px 0 12px;padding:14px 16px;border-radius:14px;border:1px solid #e8c8d7;background:#fff8fb;box-shadow:0 6px 18px rgba(107,18,66,.07);animation:samara-payment-status-in .34s cubic-bezier(.2,.8,.2,1) both}.samara-payment-send-icon{flex:0 0 38px;width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:900}.samara-payment-send-copy{min-width:0}.samara-payment-send-status strong{display:block;margin:0 0 3px;font-size:17px;line-height:1.25;font-weight:900}.samara-payment-send-status span{display:block;font-size:14.5px;line-height:1.45;font-weight:600}.samara-payment-send-status.success{border-color:#a8dfc3;background:#eefaf4;color:#17613e}.samara-payment-send-status.success .samara-payment-send-icon{background:#1dbf73;color:#fff;animation:samara-payment-check-pop .48s cubic-bezier(.2,1.6,.4,1) both}.samara-payment-send-status.progress{border-color:#edbfd4;background:#fff4f9;color:#821247}.samara-payment-send-status.progress .samara-payment-send-icon{background:#f9dbe9;color:#a10c52;animation:samara-payment-status-spin .9s linear infinite}.samara-payment-send-status.error{border-color:#f0b4b9;background:#fff1f2;color:#9e2431}.samara-payment-send-status.error .samara-payment-send-icon{background:#c72d3b;color:#fff}@keyframes samara-payment-status-in{from{opacity:0;transform:translateY(-7px) scale(.985)}to{opacity:1;transform:translateY(0) scale(1)}}@keyframes samara-payment-check-pop{0%{transform:scale(.45);opacity:.2}70%{transform:scale(1.18);opacity:1}100%{transform:scale(1)}}@keyframes samara-payment-status-spin{to{transform:rotate(360deg)}}.samara-payment-preparing{max-width:620px;margin:20px auto;text-align:center;padding:30px;border:1px solid #efc8da;border-radius:18px;background:#fff}.samara-payment-preparing strong,.samara-payment-preparing span{display:block}.samara-payment-preparing strong{color:#9d0c52;font-size:18px}.samara-payment-preparing span{margin-top:7px;color:#6d5964}
